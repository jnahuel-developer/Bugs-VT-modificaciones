    ...
    public class ManageController : BaseController
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ViewBag.StatusMessage =
                ...
                : message == ManageMessageId.SetPasswordSuccess ? "Su Contraseña ha sido seteada."
        ...
        {
            if (UserManager.Users.FirstOrDefault(x => x.Email == viewModel.NewEmail) != null)
            {
                ModelState.AddModelError("","Email existente");
            }
